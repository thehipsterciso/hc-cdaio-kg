...
## Sprint 5 — OpenStack Services, AI/ML Platform & Infrastructure

**Status:** COMPLETE
**OSINT Searches:** 6 targeted searches
**Entities added:** 20 (sys-129 through sys-148)
**Relationships added:** 48
**Running total:** 148 entities, 355 relationships
**Confirmed rate:** 20/20 (100%)

### OSINT Sources Consumed (Sprint 5)

| # | Source | Type | Conf. | Key Findings |
|---|--------|------|-------|-------------|
| 1 | docs.rackspacecloud.com/genestack-structure-and-files/ | T3 | 0.95 | Full helm-chart-versions.yaml: barbican, ceilometer, cinder, glance, gnocchi, heat, horizon, ironic, keystone, libvirt, magnum, masakari, nova, octavia, placement |
| 2 | docs.rackspacecloud.com/openstack-cloud-design-genestack-infra/ | T3 | 0.95 | Architecture diagram: Skyline→Neutron/Cinder/Nova/Glance/Keystone→Ironic→Bare Metal |
| 3 | docs.rackspacecloud.com/openstack-glance/ | T3 | 0.95 | Glance deployment, role-based image policies, glance_admin role |
| 4 | docs.rackspacecloud.com/openstack-octavia/ | T3 | 0.95 | Amphora driver, Ansible playbook deployment, Keystone integration |
| 5 | docs.rackspacecloud.com/openstack-magnum/ | T3 | 0.95 | CAPI integration, Barbican prerequisite, kubeconfig management |
| 6 | docs.rackspacecloud.com/openstack-skyline/ | T3 | 0.95 | Next-gen dashboard, Envoy HTTP Routes, SAML Federation |
| 7 | docs.rackspacecloud.com/openstack-cinder-fips-encryption/ | T3 | 0.95 | LUKS encryption, Barbican key manager default, AES-XTS-Plain64 |
| 8 | docs.rackspacecloud.com/infrastructure-mariadb/ | T3 | 0.95 | MariaDB Operator, Galera cluster, 6-hour auto backup |
| 9 | docs.rackspacecloud.com/infrastructure-mariadb-ops/ | T3 | 0.95 | MariaDB operations, backup scripts, mysqldump procedures |
| 10 | docs.rackspacecloud.com/infrastructure-rabbitmq/ | T3 | 0.95 | RabbitMQ Operator, topology operator, Prometheus monitors |
| 11 | docs.rackspacecloud.com/monitoring-info/ | T3 | 0.90 | MySQL/PostgreSQL/RabbitMQ exporters, OpenStack exporter, Envoy metrics |
| 12 | docs.rackspacecloud.com/release-notes/ | T3 | 0.90 | All chart migrations to OSH repo, OVN tech preview, masakari/cloudkitty/blazar |
| 13 | docs.rackspacecloud.com/build-test-envs/ | T3 | 0.90 | Hyperconverged lab: kubespray/talos, heat+octavia flags |
| 14 | docs.rackspace.com/docs/runai | T3 | 0.95 | Run:AI overview, fair scheduling, quota-based GPU allocation |
| 15 | docs.rackspace.com/docs/runai-triton-with-tensorrt | T3 | 0.95 | TensorRT-LLM setup, Triton Inference Server, vLLM backend |
| 16 | rackspace.com/newsroom/rackspace-ai-business Mar 25, 2025 | T1/T5 | 0.95 | AI Business platform, Dell+NVIDIA GPUs, FAIR collaboration |
| 17 | ir.rackspace.com FAIR 1st anniversary June 2024 | T1 | 0.95 | 40+ implementations, ICE/RITA tools, 500+ use cases |
| 18 | fair.rackspace.com/solutions | T9 | 0.90 | FAIR website, Ideate/Incubate/Industrialize framework |

### Entity Catalog

| ID | Name | Criticality | System Type | Source |
|----|------|-------------|-------------|--------|
| sys-129 | OpenStack Cinder Block Storage | critical | storage | T3 0.95 |
| sys-130 | OpenStack Glance Image Service | critical | application | T3 0.95 |
| sys-131 | OpenStack Heat Orchestration Engine | high | application | T3 0.95 |
| sys-132 | OpenStack Horizon Dashboard | medium | application | T3 0.95 |
| sys-133 | OpenStack Skyline Dashboard | high | application | T3 0.95 |
| sys-134 | OpenStack Octavia Load Balancer | high | application | T3 0.95 |
| sys-135 | OpenStack Ironic Bare Metal Provisioning | critical | infrastructure | T3 0.95 |
| sys-136 | OpenStack Barbican Key Management | critical | security | T3 0.95 |
| sys-137 | OpenStack Magnum Container Orchestration | high | application | T3 0.95 |
| sys-138 | OpenStack Masakari Instance HA | high | application | T3 0.90 |
| sys-139 | OpenStack Placement API | high | application | T3 0.95 |
| sys-140 | OpenStack Ceilometer Telemetry | medium | monitoring | T3 0.95 |
| sys-141 | MariaDB Galera Cluster (OpenStack) | critical | infrastructure | T3 0.95 |
| sys-142 | RabbitMQ Cluster (OpenStack) | critical | infrastructure | T3 0.95 |
| sys-143 | OVN Virtual Networking (OpenStack) | critical | network_virtualization | T3 0.95 |
| sys-144 | Run:AI GPU Orchestration Platform | high | application | T3 0.95 |
| sys-145 | Rackspace AI Business Platform | high | application | T1/T5 0.95 |
| sys-146 | FAIR Platform (Foundry for AI by Rackspace) | high | application | T1/T9 0.95 |
| sys-147 | OpenStack Gnocchi Time-Series Database | medium | application | T3 0.95 |
| sys-148 | Libvirt Virtualization Layer | critical | infrastructure | T3 0.95 |
