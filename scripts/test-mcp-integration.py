...
Usage (from ~/hc-cdaio-kg):
    poetry -C ~/hc-enterprise-kg run python3 scripts/test-mcp-integration.py
...
# This script lives in hc-cdaio-kg/scripts/; the engine is hc-enterprise-kg.
# ---------------------------------------------------------------------------
_ENGINE_DIR = Path(os.environ.get("HCKG_INSTALL_DIR", Path.home() / "hc-enterprise-kg"))
